...
@section('title', 'Tạo đơn thuốc mẫu')
        ...
        <section class="content">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input id="name" name="title" value="" class="form-control"
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <button id="addPrescriptionsRecords" type="button" class="btn btn-success">Tạo</button>
                </div>
            </div>
        </section>
    </form>
